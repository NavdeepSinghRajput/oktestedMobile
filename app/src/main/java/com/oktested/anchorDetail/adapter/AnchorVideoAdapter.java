package com.oktested.anchorDetail.adapter;
...
public class AnchorVideoAdapter extends RecyclerView.Adapter<AnchorVideoAdapter.ViewHolder> {

    private Context context;
    private ArrayList<DataItem> dataItemList;

    public AnchorVideoAdapter(Context context, ArrayList<DataItem> dataItemList) {
    ...
    public void setAnchorVideoData(ArrayList<DataItem> dataItemList) {
