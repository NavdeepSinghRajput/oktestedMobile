...
public class SearchQuizDataAdapter extends RecyclerView.Adapter<SearchQuizDataAdapter.ViewHolder> {

    private Context context;
    private ArrayList<QuizListModel> dataItemList;
    private  QuizSelected quizSelected;

    public SearchQuizDataAdapter(Context context, ArrayList<QuizListModel> dataItemList, QuizSelected quizSelected) {
