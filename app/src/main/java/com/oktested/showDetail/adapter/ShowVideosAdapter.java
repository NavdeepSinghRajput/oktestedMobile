package com.oktested.showDetail.adapter;
...
public class ShowVideosAdapter extends RecyclerView.Adapter<ShowVideosAdapter.ViewHolder> {
    ...
    public ShowVideosAdapter(Context context, ArrayList<DataItem> dataItemList) {
    ...
    public void setShowVideoData(ArrayList<DataItem> dataItemList) {
