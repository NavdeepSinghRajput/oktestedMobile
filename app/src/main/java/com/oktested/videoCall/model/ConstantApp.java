...
public class ConstantApp {
    ...
    public static final int PERMISSION_REQ_ID_CONTACTS = BASE_VALUE_PERMISSION + 3;
    ...
    public static final int DEFAULT_VIDEO_ENC_RESOLUTION_IDX = 3; //  use 360P
    public static final int DEFAULT_VIDEO_ENC_FPS_IDX = 3; //  use 15fps
    ...
    public static final String ACTION_KEY_ACCESS_TOKEN = "agora_access_token";
