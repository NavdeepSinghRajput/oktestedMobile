...
public class SinglePageViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
         ...
         * @see SinglePageViewPager#SCROLL_STATE_IDLE
         * @see SinglePageViewPager#SCROLL_STATE_DRAGGING
         * @see SinglePageViewPager#SCROLL_STATE_SETTLING
         */
    ...
    public SinglePageViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public SinglePageViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
