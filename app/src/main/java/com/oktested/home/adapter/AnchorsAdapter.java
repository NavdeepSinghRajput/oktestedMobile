...
public class AnchorsAdapter extends RecyclerView.Adapter<AnchorsAdapter.ViewHolder> {

    private Context context;
    private ArrayList<AnchorsListModel> anchorsAL;

    public AnchorsAdapter(Context context, ArrayList<AnchorsListModel> anchorsAL) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.anchors_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (Helper.isContainValue(anchorsAL.get(position).profile_pic)) {
            ...
            holder.actorIV.setImageDrawable(context.getResources().getDrawable(R.drawable.placeholder));
        }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View v) {
            super(v);
            actorIV = v.findViewById(R.id.actorIV);
