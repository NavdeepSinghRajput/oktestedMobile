...
public class LatestQuizAdapter extends RecyclerView.Adapter<LatestQuizAdapter.ViewHolder> {

    private Context context;
    private ArrayList<QuizListModel> dataItemList;
    private String sectionTitle, offset, screenName;

    LatestQuizAdapter(Context context, ArrayList<QuizListModel> dataItemList, String sectionTitle, String offset, String screenName) {
