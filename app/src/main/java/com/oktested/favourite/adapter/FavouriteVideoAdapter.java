...
public class FavouriteVideoAdapter extends RecyclerView.Adapter<FavouriteVideoAdapter.ViewHolder> {

    private Context context;
    private ArrayList<DataItem> dataItemList;
    private boolean loadAllData = false;

    public FavouriteVideoAdapter(Context context, ArrayList<DataItem> dataItemList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if (dataItemList.get(position).show != null && Helper.isContainValue(dataItemList.get(position).show.topic)) {
    ...
    public void setFavouriteVideoData(boolean loadAllData) {
